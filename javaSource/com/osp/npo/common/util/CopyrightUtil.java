...
public class CopyrightUtil {
	...
	/**
	 * Create copyright key by customer ID
	 * 
	 * @param customerID Customer ID
	 * @return Copyright key
	 * @throws UnknownHostException
	 * @throws SocketException
	 * @throws CopyrightException
	 */
	public static String createKey(String customerID) throws UnknownHostException, SocketException, CopyrightException {
		String inputString = customerID + getMACAddress();
		return Crypter.crypt(inputString);
	}
	
	/**
	 * Create copyright key by customer ID & MAC address
	 * 
	 * @param customerID Customer ID
	 ...
	 * @throws CopyrightException
	 */
	public static String createKey(String customerID, String macAddress) throws UnknownHostException, SocketException, CopyrightException {
		String inputString = customerID + macAddress;
		return Crypter.crypt(inputString);
	}
