...
public class ContractHistoryManager extends AbstractManager {
    ...
    public ContractHistoryList select(boolean forUpdate, int offset, int limit) throws SQLException, IOException {
        ...
        sqlBuffer.append(" nch.*, nno.name as office_name ");
        sqlBuffer.append(" FROM ");
        sqlBuffer.append(" npo_contract_history nch ");
        sqlBuffer.append(" INNER JOIN npo_notary_office nno ON nch.client_info=nno.authentication_id ");
    ...
    private String getWhereFilter(ArrayList<Object> prmList) {
        ...
        if (this.officeCode != null) {
        	appendAnd(filterBuffer);
            filterBuffer.append("client_info = ?");
        ...
        if (this.tpidFilter != null) {
        	appendAnd(filterBuffer);
            filterBuffer.append("tpid = ?");
            prmList.add(this.tpidFilter);
        }
     ...
     */
    public void setTpidFilter(Long tpid) {
    	this.tpidFilter = tpid;
    }
