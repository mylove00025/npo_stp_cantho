...
public class UserManager extends AbstractManager {
    ...
    public void setOfficeIdFilter(Long officeIdFilter) {
    ...
    private String getWhereFilter(ArrayList<Object> prmList) {
        ...
        if (this.officeIdFilter != null) {
            appendAnd(filterBuffer);
            filterBuffer.append("nu.office_id = ?");
            prmList.add(this.officeIdFilter);
        }
