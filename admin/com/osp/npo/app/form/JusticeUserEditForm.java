 ...
 */
public class JusticeUserEditForm extends ValidatorForm {

    private static final long serialVersionUID = 1623374245052265974L;
    private String role;
    ...
    public ActionErrors validate(ActionMapping mapping,
        ...
        JusticeUserEditViewHelper view = (JusticeUserEditViewHelper)request.getSession().getAttribute(JusticeUserEditViewHelper.SESSION_KEY);
        if (view == null) {
