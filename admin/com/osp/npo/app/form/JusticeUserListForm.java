 ...
 */
public class JusticeUserListForm extends ValidatorForm {

    private static final long serialVersionUID = -4064728399529897677L;
    private String role;
    ...
    public ActionErrors validate(ActionMapping mapping,
        ...
        JusticeUserListViewHelper view = (JusticeUserListViewHelper)
            request.getSession().getAttribute(JusticeUserListViewHelper.SESSION_KEY);
        JusticeUserListContext context = (JusticeUserListContext)request.getSession().getAttribute(JusticeUserListContext.SESSION_KEY);
