 ...
 */
public class NotaryOfficeEntryForm extends ValidatorForm {

    private static final long serialVersionUID = -3172702337147144849L;
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        NotaryOfficeEntryViewHelper view = (NotaryOfficeEntryViewHelper)request.getSession().getAttribute(NotaryOfficeEntryViewHelper.SESSION_KEY);
        if (view == null) {
