 ...
 */
public class JusticeUserEntryViewHelper extends AbstractPageListViewHelper {
    public static final String SESSION_KEY = "justiceUserEntryViewHelper";
     ...
     * @param f
     */
    public void reset(JusticeUserEntryForm f) {
