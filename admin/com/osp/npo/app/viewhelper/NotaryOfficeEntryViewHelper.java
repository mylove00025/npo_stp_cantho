 ...
 */
public class NotaryOfficeEntryViewHelper extends AbstractPageListViewHelper {
    public static final String SESSION_KEY = "notaryOfficeEntryViewHelper";
     ...
     * @param f
     */
    public void reset(NotaryOfficeEntryForm f) {
        name = f.getName();
